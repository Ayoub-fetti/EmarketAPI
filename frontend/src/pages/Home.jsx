        ...
        <div className="px-8 md:px-16 py-12 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 relative z-0">
            ...
            <p className="mt-32 text-lg text-white mb-8 leading-relaxed max-w-md">
              <span className="font-bold">FastShop</span> is a modern online store that offers a wide range of
      ...
      <section className="w-full max-w-6xl mt-20 mb-20 p-4 md:p-0">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-2xl border border-gray-100/50">
          <p className="text-center text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
            <span className="font-bold">FastShop</span>  est votre partenaire pour l'avenir. Nous sélectionnons
            des dispositifs qui non seulement surpassent les attentes, mais
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="p-8 bg-gray-50 rounded-2xl shadow-inner hover:shadow-lg transition duration-300 transform hover:-translate-y-1 border border-orange-100">
              ...
              <p className="mb-4 leading-relaxed text-gray-700">
                Rendre la <span className="font-semibold">technologie de pointe</span> accessible à tous. Nous
                sélectionnons rigoureusement des produits qui allient
                <span className="font-semibold"> performance, innovation et design épuré</span> pour chaque
                passionné de tech.
              </p>
            ...
            <div className="p-8 bg-gray-50 rounded-2xl shadow-inner hover:shadow-lg transition duration-300 transform hover:-translate-y-1 border border-orange-100">
              ...
              <ul className="space-y-3 leading-relaxed text-gray-700">
                <li className="flex items-start">
                  ...
                  Innovation Quotidienne : Un catalogue constamment mis à
                  jour avec les dernières tendances.
                </li>
                <li className="flex items-start">
                  <span className="text-orange-500 mr-2 mt-1">✓</span>
                  Transparence : Des fiches produits détaillées et des avis
                  clients vérifiés.
                </li>
                <li className="flex items-start">
                  <span className="text-orange-500 mr-2 mt-1">✓</span>
                  Support Premium : Une assistance personnalisée et rapide,
