    ...
    <section className="space-y-6">
      ...
      <section className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
        {statCards.map(({ label, value, sub, icon: Icon, iconColor, hoverColor }) => (
          <div
            key={label}
            className="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden"
          >
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md hover:shadow-lg transition-shadow duration-300 lg:col-span-2">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-orange-100 rounded-lg">
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <tr>
                {[
                  ...
                  <th
                    key={header}
                    scope="col"
                    className="px-6 py-4 text-left font-semibold text-gray-700 uppercase tracking-wider text-xs"
                  >
                    {header}
                  </th>
                ))}
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={[
                          "inline-flex items-center rounded-full px-3 py-1.5 text-xs font-bold capitalize shadow-sm",
