        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-left text-xs font-medium text-gray-500 pb-3">Command ID</th>
              ...
              <th className="text-right text-xs font-medium text-gray-500 pb-3">Montant</th>
            </tr>
          </thead>
          <tbody>
            {payments.map((payment, index) => (
              <tr key={index} className="border-b border-gray-100 last:border-0">
                <td className="py-5 text-sm font-medium text-gray-900">{payment.id}</td>
